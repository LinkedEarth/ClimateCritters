---
title: About PaleoBeasts
sidebar: get-started
---

The name comes from Wally Broecker, who characterized Earth's climate as an "angry beast" — capable of abrupt, large-amplitude shifts that defy easy extrapolation. PaleoBeasts is a collection of minimal models that try to capture pieces of that behavior in a tractable, well-understood form.
...
- **Taphonomic simulation** — real paleoclimate archives introduce noise, irregular sampling, and age uncertainty between the climate signal and the record. PaleoBeasts includes utilities for adding these effects to model output, so that the gap between clean synthetic series and proxy-like records can be explored gradually.
