...
```python
scenario = (
    cc.Hold(duration=100, value=1360.0)
    + cc.Ramp(duration=50, y0=1360.0, yf=1380.0, shape='linear')
    + cc.Hold(duration=100, value=1380.0)
)
...
forcing = cc.Forcing.from_sequence([
    cc.Hold(duration=500, value=1360.0),
    cc.Ramp(duration=200, y0=1360.0, yf=1390.0, shape='linear'),
])
