...
"""Generic box-model utilities for PaleoBeasts.

This module provides a small declarative layer on top of :class:`PBModel` for
...
class BoxModelContext:
    ...
    - ``ctx.param("k")`` for parameters resolved through ``PBModel.get_param``
...
class GenericBoxModel(PBModel):
    ...
    def uses_post_history(self):
        """Route diagnostics through PBModel's post-history hooks."""
        return True
